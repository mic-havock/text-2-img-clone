    ...
    <div className="space-y-4">
      <div className="relative">
        ...
        <button
          ...
          className="absolute bottom-3 right-3 p-2 bg-primary-600 hover:bg-primary-700 text-white rounded-lg transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
        >
